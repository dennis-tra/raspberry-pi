...
typedef struct
{
  ...
  union {  
    ...
    struct {
      __IO uint16_t BSRRL;      /*!< GPIO port bit set/reset registerBSRR,                     Address offset: 0x18 */
      __IO uint16_t BSRRH;      /*!< GPIO port bit set/reset registerBSRR,                     Address offset: 0x18 */
    };  
  };  
