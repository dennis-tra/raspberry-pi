...
// FUNKTIONEN
//*----------------------------------------------------------------------------
extern void HID_Config(T_USB *pUsb);
extern void HID_Ep0Setup(T_USB *pUsb);
extern void HID_RxReady(T_USB *pUsb);
/*
extern void HID_Out(T_USB *pUsb);
extern void HID_In(T_USB *pUsb);
extern void HID_Reset(T_USB *pUsb);
*/
//*----------------------------------------------------------------------------
#endif 
